...
/**
 * Maps an ordered list of [UIEvent]s into an ordered list of [TimelineBlock]s.
 *
 * Contract:
...
class EventTimelineRenderer {
     ...
     */
    fun render(events: List<UIEvent>): List<TimelineBlock> =
    ...
    private fun deriveStatus(event: UIEvent): String {
