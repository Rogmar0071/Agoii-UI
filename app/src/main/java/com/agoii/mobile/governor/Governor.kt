...
class Governor(
    ...
    companion object {
        ...
        val VALID_TRANSITIONS: Map<String, String> = mapOf(
            ...
            // MQP-CAPABILITY-DERIVATION-v1: CAPABILITY_DERIVED is emitted immediately after
            // CONTRACTS_GENERATED by ExecutionEntryPoint. Governor must advance to CONTRACTS_READY
            // from this state so the execution loop is not blocked (DRIFT prevented).
            EventTypes.CAPABILITY_DERIVED   to EventTypes.CONTRACTS_READY
        )
    }
